...
PinBus* MAIN_DELAY_BUS, *STEP_GEN_DELAY_BUS;
...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
	...
	//STEP_GEN_DELAY = new PinBus(11, GPIO_MODE_OUTPUT_PP, {STEP_GEN_DELAY_Q0 ,STEP_GEN_DELAY_Q1, STEP_GEN_DELAY_Q2, STEP_GEN_DELAY_Q3, STEP_GEN_DELAY_Q4, STEP_GEN_DELAY_Q5, STEP_GEN_DELAY_Q6, STEP_GEN_DELAY_Q7, STEP_GEN_DELAY_Q8, STEP_GEN_DELAY_Q9, STEP_GEN_DELAY_Q10});
	//MAIN_DELAY = new PinBus(11,GPIO_MODE_OUTPUT_PP, {MAIN_DELAY_Q0, MAIN_DELAY_Q1, MAIN_DELAY_Q2, MAIN_DELAY_Q3, MAIN_DELAY_Q4, MAIN_DELAY_Q5, MAIN_DELAY_Q6, MAIN_DELAY_Q7, MAIN_DELAY_Q8, MAIN_DELAY_Q9, MAIN_DELAY_Q10});
